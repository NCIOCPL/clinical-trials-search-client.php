...
/**
 * Model for the ClinicalTrialsCollection objects.
 *
 * @package NCIOCPL\ClinicalTrialSearch
 */
class ClinicalTrialsCollection extends ModelCommon implements ModelInterface {
   ...
   * @var string
   */
  protected static $swaggerModelName = 'ClinicalTrialsCollection';
  ...
  protected static $swaggerTypes = [
    ...
    'Trials' => 'NCIOCPL\ClinicalTrialSearch\Model\ClinicalTrial[]',
  ];
  ...
  public function __construct(array $data = NULL) {
    ...
    $this->container['Trials'] = isset($data['Trials']) ? $data['Trials'] : NULL;
  }
